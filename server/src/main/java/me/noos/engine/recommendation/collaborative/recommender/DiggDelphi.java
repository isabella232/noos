...
//        	}
//        }
        Iterator<PredictedItemRating> iter = uicList.iterator();
        while(iter.hasNext()) {
        	PredictedItemRating pR = iter.next();
        	scaledRating = pR.getRating(6) * scaling;
...
//        return PredictedItemRating.getTopNRecommendations(uicList, topN);
	...
	public static void main(String[] args) {
		...
		me.noos.engine.recommendation.collaborative.model.User user = ds.getUser(1);
